...
module.exports = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    base(airtableCMSTable)
      .select({
      maxRecords: 1000,
      fields: ["artwork_title", "date_painted", "description", "media", "dimensions", "url_name", "image_url_https", "image_height", "image_width", "portfolio_size", "tags", "go_live"], // if any field names change in airtable we need to change them here and also in the sections/macro.njk file book_covers_all_api
